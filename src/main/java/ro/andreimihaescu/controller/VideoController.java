...
public class VideoController {
    ...
    @RequestMapping("/list")
    public List<MovieResponse> getMovieListByUserRole(HttpServletRequest request) {
    ...
    public void getMovie(@PathVariable("video")Long videoNo, HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        MultipartFileSender.fromPath(Paths.get("./Silicon.Valley.S03E01.HDTV.x264-KILLERS.mkv"))
                .with(request)
                .with(response)
                .serveResource();
    }
